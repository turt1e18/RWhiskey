...
const RWhiskey = ({ className = "" }: RWhiskeyProps) => {
  return (
    // 외부에서 로고 크기를 제어할 수 있도록 className 연결
    <div className={`flex justify-center items-center h-fit ${className}`}>
      <svg
        viewBox="0 0 800 450"
        className="w-full max-w-[220px] md:max-w-[260px]"
        xmlns="http://www.w3.org/2000/svg"
      >
        {/* 텍스트 내부에 물결 색상이 보이도록 정의 */}
        <defs>
          {/* 물결 그라데이션 */}
          <linearGradient id="waveGradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#D88B3B" />
